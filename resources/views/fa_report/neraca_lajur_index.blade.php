  ...
  @if (Session::get('message')!='')
    ...
    <div class='panel panel-default'>
        <div class="panel-heading">
           <strong><i class='fa fa-file-excel-o'></i>&nbsp;Form Neraca Lajur</strong>
         </div>
    <div class='panel-body'>
      <form method='get' action='/export-neraca/'>
        ...
        <div class='form-group' style="width: 200px;">
          <label>Tahun</label>
          {{ Form::selectYear('year', 2017, 2038, 2020, ['class' => 'form-control']) }}
        </div>
