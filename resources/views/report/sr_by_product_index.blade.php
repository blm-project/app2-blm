  ...
  @if (Session::get('message')!='')
    ...
    <div class='panel panel-default'>
        <div class="panel-heading">
           <strong><i class='fa fa-file-excel-o'></i>&nbsp;Form Stock Receive by Product</strong>
         </div>
    <div class='panel-body'>
      <form method='get' action='/export-srbyproduct/'>
        ...
        <div class='form-group' style="width: 200px;">
          <label>Product</label>
          <select class="form-control select" id="product_item_id" name="product_item_id" autofocus>
