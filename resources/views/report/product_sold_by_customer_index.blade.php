  ...
  @if (Session::get('message')!='')
    ...
    <div class='panel panel-default'>
        <div class="panel-heading">
           <strong><i class='fa fa-file-excel-o'></i>&nbsp;Form Product Sold By Customer</strong>
         </div>
    <div class='panel-body'>
      <form method='get' action='/export-psbycustomer/'>
        ...
        <div class='form-group' style="width: 200px;">
          ...
          <select class="form-control select" id="customer_name" name="customer_name" autofocus>
            <option value="" >ALL</option>
            @foreach($master_customer as $row)
          <option value="{{ $row->id }}" >{{ $row->master_customer_name }}</option>
            @endforeach
        </select>
        </div>
