...
class AdminQuotationUploadController extends \crocodicstudio\crudbooster\controllers\CBController {
	...
	public function cbInit() {
			...
			$this->col = [];
			$this->col[] = ["label"=>"quot_file","name"=>"quot_upload"];
		...
		$this->form[] = ['label'=>'Upload Quotation File','name'=>'quot_upload','type'=>'upload','validation'=>'required'];
	    ...
	    */
	    public function hook_after_add($id) {        
	        //Your code here
	        return redirect('admin/quotation')->send();
